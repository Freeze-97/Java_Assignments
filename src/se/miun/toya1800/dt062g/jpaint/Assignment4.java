...
/**
 * <h1>Assignment 4</h1> This application creates a <code>Drawing</code> with a
 * name, author and different shapes in it. It then calls various methods to
 * print total circumference and area.
 *
...
public class Assignment4 {
	...
	public static void main(String[] args) throws MissingEndpointException {
		testDrawing();
	}

	private static void testDrawing() throws MissingEndpointException {
